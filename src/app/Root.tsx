  ...
  return (
    <div className={`min-h-screen ${darkMode ? "bg-gray-950" : "bg-white"}`}>
      ...
      <AnimatePresence mode="wait">
        ...
        >
          {isRoom ? <Suspense fallback={<div className={`min-h-screen flex items-center justify-center ${darkMode ? "bg-gray-950 text-indigo-400" : "bg-white text-indigo-600"}`}>正在点亮小屋…</div>}>
            <PixelRoom />
          </Suspense> : <PageContent path={location.pathname} />}
        </motion.div>
      </AnimatePresence>
